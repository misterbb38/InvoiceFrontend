      ...
      <table className="table w-full">
        <thead>
          <tr>
            ...
            <th  className="font-bold text-lg text-base-content">Téléphone</th>
          ...
          {clients.map((client) => (
            <tr key={client._id}>
              ...
              <div className="flex justify-around space-x-1">
                <EditClientButton clientId={client._id} onClientUpdated={refreshClients} />
                <button className="btn btn-error" onClick={() => deleteClient(client._id)}>Supprimer</button>
              </div>
              </td>
            </tr>
          ))}
