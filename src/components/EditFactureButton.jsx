...
//     e.preventDefault();
//     setShowToast(true); // Affiche le toast dès le clic sur "Enregistrer"
//     setTimeout(() => setShowToast(false), 10000); // Cache le toast après 3 secondes
//     try {
//       const response = await fetch(`/api/invoice/${factureId}`, {
//         method: 'PUT',
//         headers: {
...
//         setShowModal(false);
//         onFactureUpdated();
//         // Ajoutez ici du code pour rafraîchir la liste des factures ou notifier l'utilisateur
//       }
//     } catch (error) {
...
//   return (
//     <>
//       <button className="btn btn-secondary btn-sm" onClick={() => setShowModal(true)}>Éditer</button>
//       {showModal && (
...
//               <div className="form-control">
//                 <label className="label">
//                   <span className="label-text">Telepone du client</span>
//                 </label>
//                 <input
//                   className="input input-bordered"
//                   type="number"
...
//                   onChange={handleChange}
//                   placeholder="Teleppone du client"
//                 />
//               </div>
//               {/* Gestion Status */}
//               <div className="form-control">
...
//                   <label className="label">
//                     <span className="label-text">Article {index + 1}</span>
//                   </label>
//                   <input
//                     className="input input-bordered"
//                     type="text"
